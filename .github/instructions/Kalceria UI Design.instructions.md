---
description: This file outlines the UI design principles, color palette, typography, and animation strategies for the Kalceria frontend. It serves as a guide for creating a visually cohesive and performant user interface that aligns with the aggressive and high-tech aesthetic inspired by Forza Horizon, Hack The Box, and ROG.
# applyTo: '**/*.tsx, **/*.jsx' (uncomment and specify file types if needed)
---
